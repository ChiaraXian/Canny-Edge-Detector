...
/* ECPS203 Assignment 6 reference solution*/
...
SC_MODULE(Stimulus){
	...
	******************************************************************************/
	...
	void main(void)
	{
	   ...
	   for(i=0; i<IMG_NUM; i++)
	   {
	   	  //sc_time start_time=sc_get_time_resolution();
	      ...
	      ****************************************************************************/
	      ...
	      time1.write(start_time);
          start_time=sc_time_stamp();
          cout << start_time << ":Stimulus sent frame " << i+1 << ".\n"<< endl;
	   }
	}
...
SC_MODULE(Monitor){
	...
	******************************************************************************/
	...
	void main(void)
	{
	   ...
	   {
	      ImgIn.read(imagein);
	      time2.read(start_time);
	      end_time=sc_time_stamp();
          cout << end_time << ": Monitor receives frame " << i+1 << " with " << end_time-start_time << " delay.\n" << endl;
...
{
	sc_set_time_resolution(1.0000,SC_PS);
	sc_start();
	return 0;
}
